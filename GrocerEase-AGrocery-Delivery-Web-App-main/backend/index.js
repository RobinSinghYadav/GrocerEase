...
app.post('/place',fetchUser, async (req, res) => {
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            mode: 'payment',
            success_url: `${process.env.HOME_PAGE_URL}/verify?success=true&orderId=${newOrder._id}`,
            cancel_url: `${process.env.HOME_PAGE_URL}/verify?success=false&orderId=${newOrder._id}`,
        });
